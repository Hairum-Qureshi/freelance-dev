export const REJECTED_EMAIL_TEMPLATE = `<table
  width="100%"
  cellpadding="0"
  cellspacing="0"
  border="0"
        ...
        <tr>
          <td style="padding: 36px 32px 32px;">
            ...
            <p
              ...
              "
            >
              The client has decided not to move forward with your
              application for this position. Don't worry — there are plenty
              of other opportunities waiting for you on Freelance Dev.
            </p>
